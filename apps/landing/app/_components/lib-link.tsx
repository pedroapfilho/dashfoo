...
const LibLink = ({ children, href }: { children: ReactNode; href: string }): ReactNode => (
  <a
    className="decoration-border hover:text-foreground hover:decoration-foreground focus-visible:outline-ring underline underline-offset-2 focus-visible:outline-2 focus-visible:outline-offset-2"
    href={href}
