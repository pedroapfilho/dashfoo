...
- **Over a tab strip.** The drop stacks into that tabset. A tab lands at a
  specific insertion index, with a thin insertion line showing the slot; a
...
slot boundary. The line is measured against whole tab items (label plus close
button), so the "after the last tab" position sits past the last close button
rather than between the label and the close.
...
| ----------------------------- | ---------------------------------------------- | ------------------------ |
| `--dashfoo-dock-fill`         | `oklch(0.556 0 0 / 0.18)`                      | split band               |
| `--dashfoo-dock-border`       | `oklch(0.708 0 0 / 0.75)`                      | split band               |
| `--dashfoo-dock-border-width` | `1px`                                          | split band               |
| `--dashfoo-dock-radius`       | `6px`                                          | split band               |
| `--dashfoo-dock-line`         | `oklch(0.556 0 0)`                             | tab-strip insertion line |
| `--dashfoo-dock-line-radius`  | `2px`                                          | tab-strip insertion line |
| `--dashfoo-dock-transition`   | `left 60ms, top 60ms, width 60ms, height 60ms` | both overlays            |
