...
and `@dashfoo/react`
(the [drag adapter](https://github.com/pedroapfilho/dashfoo/blob/main/packages/react/src/components/drag-provider.tsx)).
...
`START` stashes the subject (its `kind` is `"tab"`, `"tabset"`, or `"external"`,
...
- [`tab-insertion.ts`](https://github.com/pedroapfilho/dashfoo/blob/main/packages/react/src/lib/tab-insertion.ts)
  ...
  no-op drop filter.
- [`drag-adapter.tsx`](https://github.com/pedroapfilho/dashfoo/blob/main/packages/react/src/components/drag-provider.tsx)
