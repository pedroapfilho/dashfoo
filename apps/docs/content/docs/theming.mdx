...
`tablist` is the scrolling viewport. The empty `role="tablist"` span inside it
...
- [`packages/react/src/components/tabset/tabset-view.tsx`](https://github.com/pedroapfilho/dashfoo/blob/main/packages/react/src/components/tabset/tabset-view.tsx) for the tabset markup and ARIA wiring.
...
- [`packages/react/src/components/drag-provider.tsx`](https://github.com/pedroapfilho/dashfoo/blob/main/packages/react/src/components/drag-provider.tsx) for the dock indicator and the `--dashfoo-dock-*` fallbacks.
