...
1. **Import the default skin.** `@dashfoo/theme` ships a complete, framework-agnostic
   ...
   opt-in dark variant. Most apps want this — the full token table is in
...
[`packages/theme/tokens.css`](https://github.com/pedroapfilho/dashfoo/blob/main/packages/theme/tokens.css)
...
- [`packages/theme/dashfoo.css`](https://github.com/pedroapfilho/dashfoo/blob/main/packages/theme/dashfoo.css) for the complete worked skin, and [`packages/theme/tokens.css`](https://github.com/pedroapfilho/dashfoo/blob/main/packages/theme/tokens.css) for the token defaults + dark overrides.
