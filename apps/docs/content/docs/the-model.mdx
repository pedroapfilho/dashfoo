...
[Concepts & terminology](/concepts) — it introduces them in one annotated
figure.
...
| `floats`            | `FloatNode[]?`     | Floating panels, each its own layout subtree. See [Floating panels](/floating-panels). |
