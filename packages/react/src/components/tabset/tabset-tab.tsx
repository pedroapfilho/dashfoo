...
const TabsetTab = forwardRef<HTMLSpanElement, TabsetTabProps>(
  ({ children, tab, ...props }, userRef): ReactNode => {
...
const TabsetTrigger = forwardRef<HTMLButtonElement, TabsetTriggerProps>(
  (
    {
      children,
      onClick,
