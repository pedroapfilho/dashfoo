...
- f22592b: Prepare the early-adopter release: restore persistence after hydration, contain
...
- 33a9856: Close the "model reaches a state no reader expects" class of bugs, and collapse
